...
| 综述预处理 | business |  | config_path | autodokit/affairs/综述预处理 |
...
| model | 否 | "auto" | "auto" |
| model_route | 否 | {"task_type": "long_text", "quality_tier": "high", "budget_tier": "balanced", "latency_tier": "medium"} | {"task_type": "long_text", "quality_tier": "high", "budget_tier": "balanced", "latency_tier": "medium"} |
...
| --- | --- | --- | --- |
| doc_id | 否 | null | null |
| input_docs_jsonl | 否 | "workflows/workflow_从PDF提取可检索文本/output/02_pdf_to_docs/docs.jsonl" | "workflows/workflow_从PDF提取可检索文本/output/02_pdf_to_docs/docs.jsonl" |
| max_chars | 否 | 12000 | 12000 |
...
outputs = aok.run_affair("单篇精读",
    config={'content_db': '',
     ...
     'use_llm': False,
     'model': 'auto',
     'model_route': {'task_type': 'long_text',
                     'quality_tier': 'high',
                     'budget_tier': 'balanced',
                     'latency_tier': 'medium'},
     'system_prompt': '你是一名严谨的学术研究助理。请用中文输出，结构清晰。',
...
| config_path | 否 | "" | "" |
| env_api_key_name | 否 | "DASHSCOPE_API_KEY" | "DASHSCOPE_API_KEY" |
| input_chars | 否 | 0 | 0 |
| latency_level | 否 | "medium" | "medium" |
| mainland_only | 否 | true | true |
| max_tokens | 否 | 1024 | 1024 |
| model | 否 | "" | "" |
| output_dir | 否 | "" | "" |
| prompt | 否 | "" | "" |
| quality_tier | 否 | "standard" | "standard" |
| region | 否 | "cn-beijing" | "cn-beijing" |
| risk_level | 否 | "medium" | "medium" |
| run_inference | 否 | false | false |
| system_prompt | 否 | "" | "" |
...
| candidates | 否 | [] | [] |
| content_db | 否 | "" | "" |
| enable_reference_block_llm | 否 | false | false |
| input_csv | 否 | "" | "" |
| min_score | 否 | 0.0 | 0.0 |
...
| required_topic_group_indices | 否 | [] | [] |
| research_topic | 否 | "" | "" |
| review_detection_fields | 否 | ["title", "keywords", "entry_type"] | ["title", "keywords", "entry_type"] |
...
| structured_extractors | 否 | {"enable_images": false} | {"enable_images": false} |
| structured_generation_required | 否 | true | true |
| structured_reuse_any_variant | 否 | true | true |
| structured_task_type | 否 | "review_deep" | "review_deep" |
| top_k | 否 | 200 | 200 |
| topic_keyword_groups | 否 | [] | [] |
| topic_terms | 否 | [] | [] |
...
```json
{
  ...
  "required_topic_group_indices": [],
  "min_topic_group_matches": 1,
  "recent_years": 5,
  "review_detection_fields": [
    "title",
    "keywords",
    "entry_type"
  ],
  "relevance_text_fields": [
    "title",
    "keywords",
    "abstract"
  ],
  "enable_reference_block_llm": false,
  "reference_block_model": "qwen-flash",
  "structured_converter": "monkeyocr",
  "structured_task_type": "review_deep",
  "structured_reuse_any_variant": true,
...
outputs = aok.run_affair("候选文献视图构建",
    config={'input_csv': '',
     ...
     'min_topic_group_matches': 1,
     'recent_years': 5,
     'review_detection_fields': ['title', 'keywords', 'entry_type'],
     'relevance_text_fields': ['title', 'keywords', 'abstract'],
     'enable_reference_block_llm': False,
     'reference_block_model': 'qwen-flash',
     'structured_converter': 'monkeyocr',
     'structured_task_type': 'review_deep',
...
| 字段 | 必填 | 默认值 | 示例值 |
| --- | --- | --- | --- |
| input_chunks_jsonl | 否 | "workflows/workflow_解析与分块/output/03_chunk/chunks.jsonl" | "workflows/workflow_解析与分块/output/03_chunk/chunks.jsonl" |
| max_features | 否 | 20000 | 20000 |
| ngram_range | 否 | [1, 2] | [1, 2] |
| output_dir | 否 | "workflows/workflow_向量化与索引构建/output/04_vector_index" | "workflows/workflow_向量化与索引构建/output/04_vector_index" |
| vectorizer_type | 否 | "tfidf" | "tfidf" |
...
| primary_attachment_normalization | 否 | {"enabled": false, "rename_mode": "preview", "allowed_attachment_types": ["fulltext", "pdf"], "update_parse_assets": true} | {"enabled": false, "rename_mode": "preview", "allowed_attachment_types": ["fulltext", "pdf"], "update_parse_assets": true} |
| sqlite_db_path | 否 | "workspace/database/references/references.db" | "workspace/database/references/references.db" |
| storage_backend | 否 | "sqlite" | "sqlite" |
| tag_list | 否 | ["房地产价格波动", "银行系统性风险"] | ["房地产价格波动", "银行系统性风险"] |
...
| pdf_match_mode | 否 | "title" | "title" |
| tag_list | 否 | ["graph", "risk", "bank", "systemic"] | ["graph", "risk", "bank", "systemic"] |
| tag_match_fields | 否 | ["title", "abstract", "keywords"] | ["title", "abstract", "keywords"] |
...
```json
{
  ...
  "sqlite_db_path": "workspace/database/references/references.db",
  "has_pdf_enable": true,
  "pdf_match_mode": "title",
  "tag_list": [
    "房地产价格波动",
...
outputs = aok.run_affair("导入和预处理文献元数据",
    config={'bibtex_path': 'workspace/references/bib/library.bib',
     ...
     'has_pdf_enable': True,
     'pdf_match_mode': 'title',
     'tag_list': ['房地产价格波动', '银行系统性风险'],
     'tag_match_fields': ['title', 'abstract', 'keywords'],
     'primary_attachment_normalization': {'enabled': False,
                                          'rename_mode': 'preview',
...
| 字段 | 必填 | 默认值 | 示例值 |
| --- | --- | --- | --- |
| input_docs_jsonl | 否 | "output/docs/docs.jsonl" | "output/docs/docs.jsonl" |
| limit | 否 | 20 | 20 |
| max_chars | 否 | 8000 | 8000 |
| model | 否 | "qwen-plus" | "qwen-plus" |
| output_dir | 否 | "output/matrix" | "output/matrix" |
...
| access_type | 否 | "open" | "open" |
| en_per_page | 否 | 20 | 20 |
| enable_local_retrieval | 否 | true | true |
| enable_online_retrieval | 否 | false | false |
| keyword_list | 否 | [] | [] |
| local_hit_threshold | 否 | 20 | 20 |
| max_local_hits | 否 | 300 | 300 |
| metadata | 否 | {} | {} |
| object_type | 否 | "literature" | "literature" |
| online_acquisition_mode | 否 | "none" | "none" |
| online_max_pages | 否 | 1 | 1 |
| online_sources | 否 | ["zh_cnki", "en_open_access"] | ["zh_cnki", "en_open_access"] |
| online_trigger_policy | 否 | "gap_only" | "gap_only" |
| output_dir | 否 | "" | "" |
| primary_attachment_normalization | 否 | {"enabled": false, "rename_mode": "preview", "allowed_attachment_types": ["fulltext", "pdf"], "update_parse_assets": true} | {"enabled": false, "rename_mode": "preview", "allowed_attachment_types": ["fulltext", "pdf"], "update_parse_assets": true} |
| query | 否 | "" | "" |
| region_type | 否 | "global" | "global" |
| request_uid | 否 | "" | "" |
| retrieval_feedback_requests | 否 | [] | [] |
| retrieval_feedback_requests_path | 否 | "" | "" |
| seed_items | 否 | [] | [] |
| source_type | 否 | "online" | "online" |
| year_end | 否 | 0 | 0 |
| year_start | 否 | 0 | 0 |
...
```json
{
  ...
  "metadata": {},
  "seed_items": [],
  "retrieval_feedback_requests": [],
  "retrieval_feedback_requests_path": "",
  "enable_local_retrieval": true,
  "max_local_hits": 300,
  "local_hit_threshold": 20,
...
outputs = aok.run_affair("检索治理",
    config={'request_uid': '',
     ...
     'enable_online_retrieval': False,
     'online_trigger_policy': 'gap_only',
     'online_sources': ['zh_cnki', 'en_open_access'],
     'online_max_pages': 1,
     'en_per_page': 20,
     'online_acquisition_mode': 'none',
     'primary_attachment_normalization': {'enabled': False,
...
| 字段 | 必填 | 默认值 | 示例值 |
| --- | --- | --- | --- |
| description | 否 | "研究主题：房地产市场与银行系统性风险的交叉研究，关注房价波动、抵押品渠道、银行风险传导与宏观审慎监管。" | "研究主题：房地产市场与银行系统性风险的交叉研究，关注房价波动、抵押品渠道、银行风险传导与宏观审慎监管。" |
| dry_run | 否 | false | false |
...
| model | 否 | "auto" | "auto" |
| model_route | 否 | {"task_type": "general", "quality_tier": "standard", "budget_tier": "balanced", "latency_tier": "medium"} | {"task_type": "general", "quality_tier": "standard", "budget_tier": "balanced", "latency_tier": "medium"} |
...
| research_domains | 否 | {"房地产": ["房地产", "房价", "住房市场", "房地产价格波动", "抵押品", "房地产周期"], "银行系统性风险": ["银行系统性风险", "系统性风险", "风险溢出", "CoVaR", "宏观审慎", "银行风险传导"], "DSGE模型": ["DSGE"]} | {"房地产": ["房地产", "房价", "住房市场", "房地产价格波动", "抵押品", "房地产周期"], "银行系统性风险": ["银行系统性风险", "系统性风险", "风险溢出", "CoVaR", "宏观审慎", "银行风险传导"], "DSGE模型": ["DSGE"]} |
| temperature | 否 | 0.2 | 0.2 |
...
根据主题词与排除词对知识条目进行快速筛选，并输出候选与排除结果。

- `content_db`：优先传入统一内容主库 `database/content/content.db` 的绝对路径；旧 `knowledge_index_path` / `literature_items_path` 仅作兼容输入。
...
| 版本 | migrated |
| 描述 |  |
| 目录 | autodokit/affairs/综述参考文献预处理与笔记骨架 |
| Runner.module |  |
| Runner.callable | execute |
| Runner.pass_mode | config_path |
| 文档源 | autodokit/affairs/综述参考文献预处理与笔记骨架/affair.md |
...
| api_key_file | 否 | "" | "" |
| content_db | 否 | "" | "" |
| enable_reference_block_llm | 否 | true | true |
| enable_reference_line_repair | 否 | true | true |
| output_dir | 否 | "" | "" |
| parse_model | 否 | "auto" | "auto" |
| placeholder_source | 否 | "placeholder_from_a065_review_scan" | "placeholder_from_a065_review_scan" |
| reference_block_max_items | 否 | 120 | 120 |
| reference_block_model | 否 | "auto" | "auto" |
| reference_line_repair_model | 否 | "auto" | "auto" |
| review_read_pool_path | 否 | "" | "" |
| review_reading_batches_path | 否 | "" | "" |
| strict_structured_only | 否 | true | true |
| structured_converter | 否 | "monkeyocr" | "monkeyocr" |
| structured_extractors | 否 | {"enable_images": false} | {"enable_images": false} |
| structured_generation_required | 否 | false | false |
...
```json
{
  ...
  "content_db": "",
  "output_dir": "",
  "review_read_pool_path": "",
  "review_reading_batches_path": "",
  "enable_reference_block_llm": true,
  "reference_block_model": "auto",
  "reference_block_max_items": 120,
  "structured_converter": "monkeyocr",
  "structured_task_type": "review_deep",
  ...
  "reference_line_repair_model": "auto",
...
服务 A06 节点，从综述候选中生成研究地图、综述种子清单与闸门审计结果。

- 输出

1. review_research_map.json
2. gate_review.json
...
本版实现保持简单：
- 从 `matrix.jsonl`（推荐）或 structured/content_db 读取材料
...
| 版本 | migrated |
| 描述 |  |
| 目录 | autodokit/affairs/综述预处理 |
| Runner.module |  |
| Runner.callable | execute |
| Runner.pass_mode | config_path |
| 文档源 | autodokit/affairs/综述预处理/affair.md |
...
本事务做什么（技术摘要，便于理解）：
- 读取内容主库 `content.db`（兼容旧 CSV 主表输入）。
- 根据配置的关键词规则、是否有本地 PDF、年份范围等做快速筛选。
- 可选启用一个“轻量语义”占位打分（基于词覆盖率），后续可替换为 embedding 相似度。

输入（必需）：
- `content_db`：内容主库路径（支持 `.db` 或兼容 CSV，含 title, abstract, keywords, pdf_path, year 等字段）。
...
| --- | --- | --- | --- |
| content_db | 否 | "" | "" |
| exclude_domains | 否 | ["DSGE模型"] | ["DSGE模型"] |
| include_domains | 否 | ["房地产", "银行系统性风险"] | ["房地产", "银行系统性风险"] |
