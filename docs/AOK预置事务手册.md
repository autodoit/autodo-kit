...
| limit | 否 | 30 | 30 |
| max_pages | 否 | 50 | 50 |
| only_candidates_csv | 否 | null | null |
| output_dir | 否 | "workflows/workflow_从PDF提取可检索文本/output/02_pdf_to_docs" | "workflows/workflow_从PDF提取可检索文本/output/02_pdf_to_docs" |
| pdf_path_field | 否 | "pdf_path" | "pdf_path" |
