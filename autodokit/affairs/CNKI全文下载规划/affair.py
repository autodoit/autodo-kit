...
def execute(config_path: Path) -> list[Path]:
    ...
    result = build_cnki_result(mode="cnki-download", access_type=str(raw_cfg.get("access_type") or "closed"), next_node="从PDF提取可检索文本", payload=payload, metadata=dict(raw_cfg.get("metadata") or {}))
