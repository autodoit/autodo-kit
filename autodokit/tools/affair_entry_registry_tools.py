...
MAINLINE_AFFAIR_ENTRY_MAP: dict[str, dict[str, Any]] = {
    ...
    "A060": {
        ...
        "callable": "execute",
        "implemented": True,
        "notes": "A060 物理吸收 A065/A070/A075，为综述链唯一保留节点。",
    },
    "A080": {
        "node_name": "普通阅读链整合事务",
        "affair_uid": "ar_A080_非综述候选视图构建",
        "module": "autodokit.affairs.非综述候选视图构建.affair",
        "callable": "execute",
        "implemented": True,
        "notes": "A080 已物理吸收 A090/A095，在同一事务内完成非综述候选预处理、粗读与批次汇总。",
    },
    "A100": {
        "node_name": "深度研读链整合事务",
        "affair_uid": "ar_A100_文献研读与正式知识回写",
        "module": "autodokit.affairs.文献研读与正式知识回写.affair",
        "callable": "execute",
        "implemented": True,
        "notes": "A100 物理吸收 A105，为深读链唯一保留节点。",
    },
    "A110": {
        "node_name": "知识收束链整合事务",
        "affair_uid": "ar_A110_文献矩阵",
        "module": "autodokit.affairs.文献矩阵.affair",
        "callable": "execute",
        "implemented": True,
        "notes": "A110 物理吸收 A120/A130，为知识收束链唯一保留节点。",
    },
    "A140": {
        "node_name": "创新与交付链整合事务",
        "affair_uid": "ar_A140_创新点池构建",
        "module": "autodokit.affairs.创新点池构建.affair",
        "callable": "execute",
        "implemented": True,
        "notes": "A140 物理吸收 A150/A160，为创新与交付链唯一保留节点。",
    },
}
