...
MAINLINE_AFFAIR_ENTRY_MAP: dict[str, dict[str, Any]] = {
    ...
    "A065": {"node_name": "综述参考文献预处理与笔记骨架", "affair_uid": "ar_A065_综述参考文献预处理与笔记骨架", "module": "autodokit.affairs.综述参考文献预处理与笔记骨架.affair", "callable": "execute", "implemented": True},
    "A070": {"node_name": "综述研读与研究脉络", "affair_uid": "ar_A070_综述研读与研究地图生成", "module": "autodokit.affairs.综述研读与研究地图生成.affair", "callable": "execute", "implemented": True},
    "A075": {"node_name": "非综述候选种子生成", "affair_uid": "ar_A075_非综述候选种子生成", "module": "autodokit.affairs.非综述候选种子生成.affair", "callable": "execute", "implemented": True},
    "A080": {"node_name": "非综述候选与预处理编排", "affair_uid": "ar_A080_非综述候选视图构建", "module": "autodokit.affairs.非综述候选视图构建.affair", "callable": "execute", "implemented": True},
    "A090": {"node_name": "文献泛读与轻量分析", "affair_uid": "ar_A090_文献泛读与粗读", "module": "autodokit.affairs.文献泛读与粗读.affair", "callable": "execute", "implemented": True},
    "A095": {"node_name": "泛读批次分析汇总", "affair_uid": "ar_A095_泛读批次分析汇总", "module": "autodokit.affairs.泛读批次分析汇总.affair", "callable": "execute", "implemented": True},
    "A100": {"node_name": "文献精解析资产化", "affair_uid": "ar_A100_文献研读与正式知识回写", "module": "autodokit.affairs.文献研读与正式知识回写.affair", "callable": "execute", "implemented": True},
    "A105": {"node_name": "文献批判性研读与标准笔记", "affair_uid": "ar_A105_文献批判性研读与标准笔记", "module": "autodokit.affairs.文献批判性研读与标准笔记.affair", "callable": "execute", "implemented": True},
    "A110": {"node_name": "文献矩阵与研究缺口", "affair_uid": "ar_A110_文献矩阵", "module": "autodokit.affairs.文献矩阵.affair", "callable": "execute", "implemented": True},
    "A120": {"node_name": "研究脉络梳理", "affair_uid": "ar_A120_研究脉络梳理", "module": "autodokit.affairs.研究脉络梳理.affair", "callable": "execute", "implemented": True},
    ...
    "A140": {"node_name": "创新点池构建", "affair_uid": "ar_A140_创新点池构建", "module": "autodokit.affairs.创新点池构建.affair", "callable": "execute", "implemented": True},
    "A150": {"node_name": "创新点可行性验证", "affair_uid": "ar_A150_创新点可行性验证", "module": "autodokit.affairs.创新点可行性验证.affair", "callable": "execute", "implemented": True},
    "A160": {"node_name": "报告收敛与交付", "affair_uid": "ar_A160_成果归档发布", "module": "autodokit.affairs.成果归档发布.affair", "callable": "execute", "implemented": True, "notes": "如需完整交付链，可在 PA 中追加 task_docs_* 事务。"},
}
